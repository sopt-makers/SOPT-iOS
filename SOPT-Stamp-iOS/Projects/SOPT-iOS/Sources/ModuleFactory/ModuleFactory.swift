...
extension ModuleFactory {
    public func makeSplashVC() -> SplashFeature.SplashVC {
    ...
    public func makeOnboardingVC() -> OnboardingFeature.OnboardingVC {
        let onboardingVC = OnboardingVC()
        //onboardingVC.factory = self
        return onboardingVC
    }

    public func makeSignInVC() -> AuthFeature.SignInVC {
    ...
    public func makeFindAccountVC() -> AuthFeature.FindAccountVC {
        let findAccountVC = FindAccountVC()
        return findAccountVC
    }

    public func makeSignUpVC() -> AuthFeature.SignUpVC {
    ...
    public func makeSignUpCompleteVC() -> AuthFeature.SignUpCompleteVC {
...
extension ModuleFactory {
    ...
    public func makeNicknameEditVC() -> SettingFeature.NicknameEditVC {
    ...
    public func makePrivacyPolicyVC() -> PrivacyPolicyVC {
        let privacyPolicyVC = PrivacyPolicyVC()
        return privacyPolicyVC
    }

    public func makeTermsOfServiceVC() -> TermsOfServiceVC {
        let termsOfServiceVC = TermsOfServiceVC()
        return termsOfServiceVC
    }

    public func makeWithdrawalVC() -> WithdrawalVC {
