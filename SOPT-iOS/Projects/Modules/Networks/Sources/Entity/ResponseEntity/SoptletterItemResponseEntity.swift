...
public struct SoptletterItemResponseEntity: Decodable {
    ...
    public let messages: [SoptletterMessageEntity]
    
    public init(topicId: Int, title: String, totalCount: Int, nextCursor: Int?, hasNext: Bool, messages: [SoptletterMessageEntity]) {
...
public struct SoptletterMessageEntity: Decodable {
